...
import advsearch.othello_aurafarmer.minimax as minimax
import advsearch.othello_aurafarmer.tttm_minimax as tttm_agent
...
class TestAlphaBetaTTTM(unittest.TestCase):
    ...
    def test_utility(self):
        """
        Esse teste verifica a funcao utility em advsearch.othello_aurafarmer.tttm_minimax
        """
